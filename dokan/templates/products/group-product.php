...
<div class="dokan-group-product-content show_if_grouped">
    ...
    <select class="dokan-form-control dokan-product-search" multiple="multiple" style="width: 100%;" id="grouped_products" name="grouped_products[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'dokan' ); ?>" data-action="dokan_json_search_products_and_variations" data-exclude="<?php echo intval( $post->ID ); ?>" data-user_ids="<?php echo get_current_user_id(); ?>">
        <?php
